 ...
 * @param {string} username.pool.client.userAgent - CognitoUserClient information user agent 
 ...
 * @param {string} username.client.userAgent - CognitoUserClient information user agent 
